...
public class Lista_Comentarios_Adapter extends ArrayAdapter<Comentarios> {

    public Lista_Comentarios_Adapter(Context context, int textViewResourceId) {
        super(context, textViewResourceId);
    }

    public Lista_Comentarios_Adapter(Context context, int resource, List<Comentarios> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate(R.layout.item_lista_comentarios, null);
        }

        Comentarios atividade = getItem(position);
        ...
        if (atividade != null) {
            ...
            TextView comentario_text_view=(TextView) v.findViewById(R.id.comentario_text_view);
            String texto_atividade=atividade.getAtividade();
            String texto_comentario=atividade.getComentario();
            ...
            if (atividade_text_view != null) {
                ...
                comentario_text_view.setText(texto_comentario);
            }
